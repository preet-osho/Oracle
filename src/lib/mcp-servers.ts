...
export async function executeMCPTool(
  ...
  searchApiKeys?: Partial<Record<SearchProvider, string>>,
): Promise<ToolResult> {
  switch (serverName) {
    case 'seo':
    ...
    case 'research':
      return handleResearchTool(toolName, {
        ...(input as unknown as ResearchToolInput),
        apiKeys: searchApiKeys || (input as unknown as ResearchToolInput).apiKeys,
      } as ResearchToolInput);
    default:
      return {
